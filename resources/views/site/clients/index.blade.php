...
@section('content')
<section>
  <div class="app-clients col-md-12">
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="col-md-12 no-side-padding">
        <div class="col-md-9 clients-container">
          <article>
            <div class="client col-md-12 no-side-padding">
              <header>
                <div class="header">
              ...
              <div class="col-md-12 no-side-padding">
                <div class="col-md-3 no-side-padding">
                  <img src="{!! asset('public/assets/img/img-bbetos.jpg') !!}" class="thumbnail">
                </div>
                <div class="col-md-9">
          ...
          <article>
            <div class="client col-md-12 no-side-padding">
              ...
              <div class="col-md-12 no-side-padding">
                <div class="col-md-3 no-side-padding">
                  <img src="{!! asset('public/assets/img/img-outcom.jpg') !!}" class="thumbnail">
                </div>
                <div class="col-md-9">
          ...
          <article>
            <div class="client col-md-12 no-side-padding">
              ...
              <div class="col-md-12 no-side-padding">
                <div class="col-md-3 no-side-padding">
                  <img src="{!! asset('public/assets/img/img-hotdogs-congregacion.jpg') !!}" class="thumbnail">
                </div>
                <div class="col-md-9">
